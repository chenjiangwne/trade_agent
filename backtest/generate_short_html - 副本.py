...
def generate_interactive_html_with_dashboard(df, backtest_report, output_name="strategy_backtest_dashboard_short.html"):
    """
...
if __name__ == "__main__":
    four_path = "backtest_result_short_signals.xlsx"
