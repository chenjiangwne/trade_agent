...
def backtest_long_refined(
    df_4h,
    fee_rate=0.0004,            # single-side fee rate per trade leg
    enable_streak_sizing=False, # enable dynamic position sizing by win/loss streak
...
if __name__ == "__main__":
    ...
    if os.path.exists(four_path):
        ...
        report_stats = backtest_long_refined(
            df_4h=df_4h,
        ...
        print("\n" + "=" * 40)
        print("BTC 每次固定 1 BTC 做多回测报告 (绝对金额)")
        print("=" * 40)
